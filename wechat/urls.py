...
from wechat.views import LoginView, MainSelectorView, CalcSelectorView, Calc1ToNView, Calc1To1View, CalcNTo1View, HistoryView, ProcessorView

urlpatterns = [
    url(r'^processor$', ProcessorView.as_view(), name='processor'),
