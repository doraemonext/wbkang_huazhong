...
from api.views import LoginAPI, BonusHistoryAPI, BonusHistoryDateListAPI, Info1ToNAPI, Calc1ToNAPI, Info1To1API, Calc1To1API, InfoNTo1API, CalcNTo1API
...
urlpatterns = [
    ...
    url(r'^infonto1$', InfoNTo1API.as_view(), name='infonto1'),
    url(r'^calc1ton$', Calc1ToNAPI.as_view(), name='calc1ton'),
    url(r'^calc1to1$', Calc1To1API.as_view(), name='calc1to1'),
    url(r'^calcnto1$', CalcNTo1API.as_view(), name='calcnto1'),
